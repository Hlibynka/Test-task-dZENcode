  ...
  <div class="comment-item">
    <div class="comment-header">
      ...
      <span v-if="comment.home_page" class="homepage-link">
        <a :href="comment.home_page" target="_blank">🏠</a>
      </span>
...
<style scoped>
/* Lightbox style */
.comment-item { border: 1px solid #ddd; padding: 15px; margin-top: 15px; border-radius: 5px; background-color: #fff; }
...
.close-btn {
  ...
  width: 30px; height: 30px; font-size: 20px; line-height: 28px; cursor: pointer;
